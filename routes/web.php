...
// Route::get('/', HomePage::class)->name('homeroute');
...
Route::group(['middleware' => ['auth:sanctum', 'verified', 'canbook']], function(){

    Route::get('/appointment', BookingSection::class)->name('bookingform');
    Route::get('/checkdata', RecheckBooking::class)->name('checkappointment');
